...
/**
 * This class defines the structure of the 'service_documents' table.
 *
 *
 *
 ...
 */
class ServiceDocumentTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'model.map.ServiceDocumentTableMap';
	...
	{
		// attributes
		$this->setName('service_documents');
		$this->setPhpName('ServiceDocument');
		$this->setClassname('ServiceDocument');

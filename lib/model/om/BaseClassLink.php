...
/**
 * Base class that represents a row from the 'class_links' table.
 *
 *
 *
 * @package    propel.generator.model.om
 */
abstract class BaseClassLink extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ClassLinkPeer';
     ...
     * @return ClassLink The current object (for fluent API support)
     */
    public function setSchoolClassId($v)
    {
        ...
        if ($this->school_class_id !== $v) {
            ...
            $this->modifiedColumns[] = ClassLinkPeer::SCHOOL_CLASS_ID;
        }
    ...
    public function setLinkId($v)
    {
        ...
        if ($this->link_id !== $v) {
            $this->link_id = $v;
            $this->modifiedColumns[] = ClassLinkPeer::LINK_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClassLinkPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClassLinkPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = ClassLinkPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = ClassLinkPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = ClassLinkPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ClassLink object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aLink !== null && $this->link_id !== $this->aLink->getId()) {
            $this->aLink = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ClassLinkPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ClassLinkQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // denyable behavior
            if(!(ClassLinkPeer::isIgnoringRights() || $this->mayOperate("delete"))) {
                throw new PropelException(new NotPermittedException("delete.by_role", array("role_key" => "class_links")));
            }
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // denyable behavior
                if(!(ClassLinkPeer::isIgnoringRights() || $this->mayOperate("insert"))) {
                    throw new PropelException(new NotPermittedException("insert.by_role", array("role_key" => "class_links")));
                }

                // extended_timestampable behavior
                if (!$this->isColumnModified(ClassLinkPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ClassLinkPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if (!$this->isColumnModified(ClassLinkPeer::CREATED_BY)) {
                        $this->setCreatedBy(Session::getSession()->getUser()->getId());
                    }
                    if (!$this->isColumnModified(ClassLinkPeer::UPDATED_BY)) {
                ...
                // denyable behavior
                if(!(ClassLinkPeer::isIgnoringRights() || $this->mayOperate("update"))) {
                    throw new PropelException(new NotPermittedException("update.by_role", array("role_key" => "class_links")));
                }

                // extended_timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ClassLinkPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(ClassLinkPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                ClassLinkPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aLink !== null) {
                if ($this->aLink->isModified() || $this->aLink->isNew()) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ClassLinkPeer::SCHOOL_CLASS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`school_class_id`';
        }
        if ($this->isColumnModified(ClassLinkPeer::LINK_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `class_links` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ClassLinkPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ClassLinkPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ClassLink'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ClassLink'][serialize($this->getPrimaryKey())] = true;
        $keys = ClassLinkPeer::getFieldNames($keyType);
        $result = array(
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aLink) {
                $result['Link'] = $this->aLink->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClassLinkPeer::SCHOOL_CLASS_ID)) $criteria->add(ClassLinkPeer::SCHOOL_CLASS_ID, $this->school_class_id);
        if ($this->isColumnModified(ClassLinkPeer::LINK_ID)) $criteria->add(ClassLinkPeer::LINK_ID, $this->link_id);
        if ($this->isColumnModified(ClassLinkPeer::CREATED_AT)) $criteria->add(ClassLinkPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ClassLinkPeer::UPDATED_AT)) $criteria->add(ClassLinkPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(ClassLinkPeer::CREATED_BY)) $criteria->add(ClassLinkPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(ClassLinkPeer::UPDATED_BY)) $criteria->add(ClassLinkPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(ClassLinkPeer::DATABASE_NAME);
        $criteria->add(ClassLinkPeer::SCHOOL_CLASS_ID, $this->school_class_id);
        $criteria->add(ClassLinkPeer::LINK_ID, $this->link_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getSchoolClassId()) && (null === $this->getLinkId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ClassLink (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ClassLink Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ClassLinkPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ClassLinkPeer();
        }
    ...
    public function getSchoolClass(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSchoolClass === null && ($this->school_class_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSchoolClass->addClassLinks($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function setLink(Link $v = null)
    {
        if ($v === null) {
            $this->setLinkId(NULL);
        } else {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Link object, it will not be re-added.
        if ($v !== null) {
            $v->addClassLink($this);
        }
     ...
     * @throws PropelException
     */
    public function getLink(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLink === null && ($this->link_id !== null) && $doQuery) {
            $this->aLink = LinkQuery::create()->findPk($this->link_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLink->addClassLinks($this);
             */
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addClassLinkRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCreatedBy->addClassLinksRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addClassLinkRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addClassLinksRelatedByUpdatedBy($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aLink instanceof Persistent) {
              $this->aLink->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(ClassLinkPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && ClassLinkPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(ClassLinkPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleClassLinkOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }

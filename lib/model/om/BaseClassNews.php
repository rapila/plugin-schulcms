...
/**
 * Base class that represents a row from the 'class_news' table.
 *
 *
 *
 * @package    propel.generator.model.om
 */
abstract class BaseClassNews extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ClassNewsPeer';
     ...
     * @return ClassNews The current object (for fluent API support)
     */
    public function setSchoolClassId($v)
    {
        ...
        if ($this->school_class_id !== $v) {
            ...
            $this->modifiedColumns[] = ClassNewsPeer::SCHOOL_CLASS_ID;
        }
    ...
    public function setNewsId($v)
    {
        ...
        if ($this->news_id !== $v) {
            $this->news_id = $v;
            $this->modifiedColumns[] = ClassNewsPeer::NEWS_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClassNewsPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClassNewsPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = ClassNewsPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = ClassNewsPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->news_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            return $startcol + 6; // 6 = ClassNewsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ClassNews object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ClassNewsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ClassNewsQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // denyable behavior
            if(!(ClassNewsPeer::isIgnoringRights() || $this->mayOperate("delete"))) {
                throw new PropelException(new NotPermittedException("delete.by_role", array("role_key" => "class_news")));
            }
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ClassNewsPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ClassNewsPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if (!$this->isColumnModified(ClassNewsPeer::CREATED_BY)) {
                        $this->setCreatedBy(Session::getSession()->getUser()->getId());
                    }
                    if (!$this->isColumnModified(ClassNewsPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }

                // denyable behavior
                if(!(ClassNewsPeer::isIgnoringRights() || $this->mayOperate("insert"))) {
                    throw new PropelException(new NotPermittedException("insert.by_role", array("role_key" => "class_news")));
                }

            } else {
                $ret = $ret && $this->preUpdate($con);
                // extended_timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ClassNewsPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(ClassNewsPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
                // denyable behavior
                if(!(ClassNewsPeer::isIgnoringRights() || $this->mayOperate("update"))) {
                    throw new PropelException(new NotPermittedException("update.by_role", array("role_key" => "class_news")));
                }
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ClassNewsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ClassNewsPeer::SCHOOL_CLASS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`school_class_id`';
        }
        if ($this->isColumnModified(ClassNewsPeer::NEWS_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `class_news` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ClassNewsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ClassNewsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ClassNews'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ClassNews'][serialize($this->getPrimaryKey())] = true;
        $keys = ClassNewsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSchoolClassId(),
            $keys[1] => $this->getNewsId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aNews) {
                $result['News'] = $this->aNews->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setNewsId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClassNewsPeer::SCHOOL_CLASS_ID)) $criteria->add(ClassNewsPeer::SCHOOL_CLASS_ID, $this->school_class_id);
        if ($this->isColumnModified(ClassNewsPeer::NEWS_ID)) $criteria->add(ClassNewsPeer::NEWS_ID, $this->news_id);
        if ($this->isColumnModified(ClassNewsPeer::CREATED_AT)) $criteria->add(ClassNewsPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ClassNewsPeer::UPDATED_AT)) $criteria->add(ClassNewsPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(ClassNewsPeer::CREATED_BY)) $criteria->add(ClassNewsPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(ClassNewsPeer::UPDATED_BY)) $criteria->add(ClassNewsPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(ClassNewsPeer::DATABASE_NAME);
        $criteria->add(ClassNewsPeer::SCHOOL_CLASS_ID, $this->school_class_id);
        $criteria->add(ClassNewsPeer::NEWS_ID, $this->news_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getSchoolClassId()) && (null === $this->getNewsId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ClassNews (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ClassNews Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ClassNewsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ClassNewsPeer();
        }
    ...
    public function getSchoolClass(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSchoolClass === null && ($this->school_class_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSchoolClass->addClassNewss($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function getNews(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aNews === null && ($this->news_id !== null) && $doQuery) {
            $this->aNews = NewsQuery::create()->findPk($this->news_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aNews->addClassNewss($this);
             */
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addClassNewsRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCreatedBy->addClassNewssRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addClassNewsRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addClassNewssRelatedByUpdatedBy($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aNews instanceof Persistent) {
              $this->aNews->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(ClassNewsPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        $bIsAllowed = false;
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && ClassNewsPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(ClassNewsPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleClassNewsOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }

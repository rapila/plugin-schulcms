...
abstract class BaseClassStudent extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = ClassStudentPeer::NUM_COLUMNS - ClassStudentPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		if ($includeForeignObjects) {
			if (null !== $this->aSchoolClass) {
				$result['SchoolClass'] = $this->aSchoolClass->toArray($keyType, $includeLazyLoadColumns, true);
			}
			if (null !== $this->aStudent) {
				$result['Student'] = $this->aStudent->toArray($keyType, $includeLazyLoadColumns, true);
			}

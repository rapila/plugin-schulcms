...
/**
 * Base class that represents a row from the 'class_students' table.
 *
 *
 *
 * @package    propel.generator.model.om
 */
abstract class BaseClassStudent extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ClassStudentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ClassStudentPeer
     */
    ...
    /**
     * Initializes internal state of BaseClassStudent object.
     * @see        applyDefaults()
     */
     ...
     * @return ClassStudent The current object (for fluent API support)
     */
    public function setSchoolClassId($v)
    {
        ...
        if ($this->school_class_id !== $v) {
            ...
            $this->modifiedColumns[] = ClassStudentPeer::SCHOOL_CLASS_ID;
        }
    ...
    public function setFunctionName($v)
    {
        ...
        if ($this->function_name !== $v) {
            ...
            $this->modifiedColumns[] = ClassStudentPeer::FUNCTION_NAME;
        }
    ...
    public function setStudentId($v)
    {
        ...
        if ($this->student_id !== $v) {
            $this->student_id = $v;
            $this->modifiedColumns[] = ClassStudentPeer::STUDENT_ID;
        }
    ...
    public function setIsNewlyUpdated($v)
    {
        ...
        if ($this->is_newly_updated !== $v) {
            ...
            $this->modifiedColumns[] = ClassStudentPeer::IS_NEWLY_UPDATED;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClassStudentPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClassStudentPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = ClassStudentPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = ClassStudentPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->is_newly_updated = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
            ...
            return $startcol + 8; // 8 = ClassStudentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ClassStudent object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ClassStudentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ClassStudentQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // denyable behavior
            if(!(ClassStudentPeer::isIgnoringRights() || $this->mayOperate("delete"))) {
                throw new PropelException(new NotPermittedException("delete.by_role", array("role_key" => "class_students")));
            }
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ClassStudentPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ClassStudentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if (!$this->isColumnModified(ClassStudentPeer::CREATED_BY)) {
                        $this->setCreatedBy(Session::getSession()->getUser()->getId());
                    }
                    if (!$this->isColumnModified(ClassStudentPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }

                // denyable behavior
                if(!(ClassStudentPeer::isIgnoringRights() || $this->mayOperate("insert"))) {
                    throw new PropelException(new NotPermittedException("insert.by_role", array("role_key" => "class_students")));
                }

            } else {
                $ret = $ret && $this->preUpdate($con);
                // extended_timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ClassStudentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(ClassStudentPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
                // denyable behavior
                if(!(ClassStudentPeer::isIgnoringRights() || $this->mayOperate("update"))) {
                    throw new PropelException(new NotPermittedException("update.by_role", array("role_key" => "class_students")));
                }
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ClassStudentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ClassStudentPeer::SCHOOL_CLASS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`school_class_id`';
        }
        if ($this->isColumnModified(ClassStudentPeer::FUNCTION_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`function_name`';
        }
        if ($this->isColumnModified(ClassStudentPeer::STUDENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`student_id`';
        }
        if ($this->isColumnModified(ClassStudentPeer::IS_NEWLY_UPDATED)) {
        ...
        $sql = sprintf(
            'INSERT INTO `class_students` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ClassStudentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ClassStudentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ClassStudent'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ClassStudent'][serialize($this->getPrimaryKey())] = true;
        $keys = ClassStudentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSchoolClassId(),
            $keys[1] => $this->getFunctionName(),
            $keys[2] => $this->getStudentId(),
            $keys[3] => $this->getIsNewlyUpdated(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setIsNewlyUpdated($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClassStudentPeer::SCHOOL_CLASS_ID)) $criteria->add(ClassStudentPeer::SCHOOL_CLASS_ID, $this->school_class_id);
        if ($this->isColumnModified(ClassStudentPeer::FUNCTION_NAME)) $criteria->add(ClassStudentPeer::FUNCTION_NAME, $this->function_name);
        if ($this->isColumnModified(ClassStudentPeer::STUDENT_ID)) $criteria->add(ClassStudentPeer::STUDENT_ID, $this->student_id);
        if ($this->isColumnModified(ClassStudentPeer::IS_NEWLY_UPDATED)) $criteria->add(ClassStudentPeer::IS_NEWLY_UPDATED, $this->is_newly_updated);
        if ($this->isColumnModified(ClassStudentPeer::CREATED_AT)) $criteria->add(ClassStudentPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ClassStudentPeer::UPDATED_AT)) $criteria->add(ClassStudentPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(ClassStudentPeer::CREATED_BY)) $criteria->add(ClassStudentPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(ClassStudentPeer::UPDATED_BY)) $criteria->add(ClassStudentPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(ClassStudentPeer::DATABASE_NAME);
        $criteria->add(ClassStudentPeer::SCHOOL_CLASS_ID, $this->school_class_id);
        $criteria->add(ClassStudentPeer::STUDENT_ID, $this->student_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getSchoolClassId()) && (null === $this->getStudentId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ClassStudent (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ClassStudent Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ClassStudentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ClassStudentPeer();
        }
    ...
    public function getSchoolClass(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSchoolClass === null && ($this->school_class_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSchoolClass->addClassStudents($this);
             */
        }
    ...
    public function getStudent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aStudent === null && ($this->student_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aStudent->addClassStudents($this);
             */
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addClassStudentRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCreatedBy->addClassStudentsRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addClassStudentRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addClassStudentsRelatedByUpdatedBy($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ClassStudentPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && ClassStudentPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(ClassStudentPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleClassStudentOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }

...
abstract class BaseClassTeacher extends BaseObject  implements Persistent
{
	...
	/**
	 * Set the value of [is_class_teacher] column.
	 * 
	...
	public function setIsClassTeacher($v)
	{
		...
		if ($this->is_class_teacher !== $v || $this->isNew()) {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 9; // 9 = ClassTeacherPeer::NUM_COLUMNS - ClassTeacherPeer::NUM_LAZY_LOAD_COLUMNS).

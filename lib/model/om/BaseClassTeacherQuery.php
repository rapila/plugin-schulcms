 ...
 * @method ClassTeacherQuery orderByIsNewlyUpdated($order = Criteria::ASC) Order by the is_newly_updated column
 ...
 * @method ClassTeacherQuery groupByIsNewlyUpdated() Group by the is_newly_updated column
 ...
 * @method ClassTeacher findOneByIsNewlyUpdated(boolean $is_newly_updated) Return the first ClassTeacher filtered by the is_newly_updated column
 ...
 * @method array findByIsNewlyUpdated(boolean $is_newly_updated) Return ClassTeacher objects filtered by the is_newly_updated column
...
abstract class BaseClassTeacherQuery extends ModelCriteria
{
     ...
     * @param   ClassTeacherQuery|Criteria $criteria Optional Criteria to build the query from
     *
    ...
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new ClassTeacherQuery(null, null, $modelAlias);
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$school_class_id, $team_member_id, $function_name]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   ClassTeacher|ClassTeacher[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = ClassTeacherPeer::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1], (string) $key[2]))))) && !$this->formatter) {
     ...
     *
     * @return                 ClassTeacher A model object, or null if the key is not found
     * @throws PropelException
     */
    protected function findPkSimple($key, $con)
    {
        $sql = 'SELECT `school_class_id`, `team_member_id`, `function_name`, `sort_order`, `is_class_teacher`, `is_newly_updated`, `created_at`, `updated_at`, `created_by`, `updated_by` FROM `class_teachers` WHERE `school_class_id` = :p0 AND `team_member_id` = :p1 AND `function_name` = :p2';
        try {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            ClassTeacherPeer::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1], (string) $key[2])));
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|ClassTeacher[]|mixed the list of results, formatted by the current formatter
     */
    ...
    public function filterBySchoolClassId($schoolClassId = null, $comparison = null)
    {
        if (is_array($schoolClassId)) {
            ...
            if (isset($schoolClassId['min'])) {
                $this->addUsingAlias(ClassTeacherPeer::SCHOOL_CLASS_ID, $schoolClassId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($schoolClassId['max'])) {
                $this->addUsingAlias(ClassTeacherPeer::SCHOOL_CLASS_ID, $schoolClassId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByTeamMemberId($teamMemberId = null, $comparison = null)
    {
        if (is_array($teamMemberId)) {
            ...
            if (isset($teamMemberId['min'])) {
                $this->addUsingAlias(ClassTeacherPeer::TEAM_MEMBER_ID, $teamMemberId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($teamMemberId['max'])) {
                $this->addUsingAlias(ClassTeacherPeer::TEAM_MEMBER_ID, $teamMemberId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByIsClassTeacher($isClassTeacher = null, $comparison = null)
    {
        if (is_string($isClassTeacher)) {
            $isClassTeacher = in_array(strtolower($isClassTeacher), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }
    ...
    public function filterByIsNewlyUpdated($isNewlyUpdated = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ClassTeacherPeer::IS_NEWLY_UPDATED, $isNewlyUpdated, $comparison);
    }

...
abstract class BaseClassType extends BaseObject implements Persistent
{
    ...
    public function setSchoolClasss(PropelCollection $schoolClasss, PropelPDO $con = null)
    {
        ...
        foreach ($schoolClasssToDelete as $schoolClassRemoved) {
            $schoolClassRemoved->setClassType(null);
        }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && ClassTypePeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(ClassTypePeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleClassTypeOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }

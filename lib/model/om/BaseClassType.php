...
/**
 * Base class that represents a row from the 'class_types' table.
 *
 * 
 *
 * @package    propel.generator.model.om
 */
abstract class BaseClassType extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'ClassTypePeer';
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ClassTypePeer::ID;
		}
	...
	public function setOriginalName($v)
	{
		...
		if ($this->original_name !== $v) {
			...
			$this->modifiedColumns[] = ClassTypePeer::ORIGINAL_NAME;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = ClassTypePeer::NAME;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = ClassTypePeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = ClassTypePeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = ClassTypePeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = ClassTypePeer::UPDATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = ClassTypePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating ClassType object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ClassTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				if (!$this->isColumnModified(ClassTypePeer::UPDATED_AT)) {
					$this->setUpdatedAt(time());
				}
				// attributable behavior
				
				if(Session::getSession()->isAuthenticated()) {
					if (!$this->isColumnModified(ClassTypePeer::CREATED_BY)) {
						$this->setCreatedBy(Session::getSession()->getUser()->getId());
					}
					if (!$this->isColumnModified(ClassTypePeer::UPDATED_BY)) {
				...
				if(Session::getSession()->isAuthenticated()) {
					if ($this->isModified() && !$this->isColumnModified(ClassTypePeer::UPDATED_BY)) {
						$this->setUpdatedBy(Session::getSession()->getUser()->getId());
					}
				}
			}
			if ($ret) {
				...
				$this->postSave($con);
				ClassTypePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(ClassTypePeer::ID)) {
		...
		$sql = sprintf(
			'INSERT INTO `class_types` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ClassTypePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ClassTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['ClassType'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['ClassType'][$this->getPrimaryKey()] = true;
		$keys = ClassTypePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ClassTypePeer::UPDATED_BY)) $criteria->add(ClassTypePeer::UPDATED_BY, $this->updated_by);
	...
	{
		$criteria = new Criteria(ClassTypePeer::DATABASE_NAME);
		$criteria->add(ClassTypePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ClassType (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ClassType Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ClassTypePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ClassTypePeer();
		}
		return self::$peer;
	}
	...
	public function setUserRelatedByCreatedBy(User $v = null)
	{
		...
		if ($v !== null) {
			$v->addClassTypeRelatedByCreatedBy($this);
		}
	...
	public function getUserRelatedByCreatedBy(PropelPDO $con = null)
	{
		if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aUserRelatedByCreatedBy->addClassTypesRelatedByCreatedBy($this);
			 */
		}
	...
	public function setUserRelatedByUpdatedBy(User $v = null)
	{
		...
		// If this object has already been added to the User object, it will not be re-added.
		if ($v !== null) {
			$v->addClassTypeRelatedByUpdatedBy($this);
		}
	...
	public function getUserRelatedByUpdatedBy(PropelPDO $con = null)
	{
		if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aUserRelatedByUpdatedBy->addClassTypesRelatedByUpdatedBy($this);
			 */
		}
	 ...
	 * If this ClassType is new, it will return
	 ...
	 * Otherwise if this ClassType is new, it will return
	 * an empty collection; or if this ClassType has previously
	 * been saved, it will retrieve related SchoolClasss from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in ClassType.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object

...
abstract class BaseEvent extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the show_on_frontpage field.
	 * Note: this column has a database default value of: false
	 * @var        boolean
	 */
	protected $show_on_frontpage;
	...
	/**
	 * @var        array EventDocument[] Collection to store aggregation of EventDocument objects.
	 */
	...
	/**
	 * Get the [show_on_frontpage] column value.
	 * 
	 * @return     boolean
	 */
	public function getShowOnFrontpage()
	{
		return $this->show_on_frontpage;
	}
	...
	/**
	 * Set the value of [show_on_frontpage] column.
	 * 
	 * @param      boolean $v new value
	 * @return     Event The current object (for fluent API support)
	 */
	public function setShowOnFrontpage($v)
	{
		if ($v !== null) {
			$v = (boolean) $v;
		}

		if ($this->show_on_frontpage !== $v || $this->isNew()) {
			$this->show_on_frontpage = $v;
			$this->modifiedColumns[] = EventPeer::SHOW_ON_FRONTPAGE;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if ($this->show_on_frontpage !== false) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->show_on_frontpage = ($row[$startcol + 11] !== null) ? (boolean) $row[$startcol + 11] : null;
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 10:
				...
				break;
			case 11:
				return $this->getShowOnFrontpage();
				break;
			case 12:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[11] => $this->getShowOnFrontpage(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[11], $arr)) $this->setShowOnFrontpage($arr[$keys[11]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EventPeer::SHOW_ON_FRONTPAGE)) $criteria->add(EventPeer::SHOW_ON_FRONTPAGE, $this->show_on_frontpage);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTitleNormalized($this->title_normalized);
		$copyObj->setTeaser($this->teaser);
		$copyObj->setBodyPreview($this->body_preview);
		$copyObj->setBodyReview($this->body_review);
		$copyObj->setLocationInfo($this->location_info);
		$copyObj->setDateStart($this->date_start);
		$copyObj->setDateEnd($this->date_end);
		$copyObj->setTimeDetails($this->time_details);
		$copyObj->setIsActive($this->is_active);
		$copyObj->setShowOnFrontpage($this->show_on_frontpage);
	...
	{
		if ($this->aDocumentCategory === null && ($this->gallery_id !== null)) {
	 ...
	 * @return     void
	 */
	public function initEventDocuments()
	{
	 ...
	 * @return     PropelCollection|array EventDocument[] List of EventDocument objects
	 * @throws     PropelException
	 */
	public function getEventDocuments($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collEventDocuments || null !== $criteria) {
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collEventDocuments) {
				foreach ((array) $this->collEventDocuments as $o) {

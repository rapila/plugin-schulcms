...
/**
 * Base class that represents a row from the 'event_documents' table.
 *
 *
 *
 * @package    propel.generator.model.om
 */
abstract class BaseEventDocument extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'EventDocumentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        EventDocumentPeer
     */
     ...
     * @return EventDocument The current object (for fluent API support)
     */
    public function setEventId($v)
    {
        ...
        if ($this->event_id !== $v) {
            $this->event_id = $v;
            $this->modifiedColumns[] = EventDocumentPeer::EVENT_ID;
        }
    ...
    public function setDocumentId($v)
    {
        ...
        if ($this->document_id !== $v) {
            $this->document_id = $v;
            $this->modifiedColumns[] = EventDocumentPeer::DOCUMENT_ID;
        }
    ...
    public function setSort($v)
    {
        ...
        if ($this->sort !== $v) {
            $this->sort = $v;
            $this->modifiedColumns[] = EventDocumentPeer::SORT;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = EventDocumentPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = EventDocumentPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = EventDocumentPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = EventDocumentPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = EventDocumentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating EventDocument object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EventDocumentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(EventDocumentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if (!$this->isColumnModified(EventDocumentPeer::CREATED_BY)) {
                        $this->setCreatedBy(Session::getSession()->getUser()->getId());
                    }
                    if (!$this->isColumnModified(EventDocumentPeer::UPDATED_BY)) {
                ...
                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(EventDocumentPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                EventDocumentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EventDocumentPeer::EVENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`event_id`';
        }
        if ($this->isColumnModified(EventDocumentPeer::DOCUMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`document_id`';
        }
        if ($this->isColumnModified(EventDocumentPeer::SORT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `event_documents` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EventDocumentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EventDocumentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['EventDocument'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EventDocument'][serialize($this->getPrimaryKey())] = true;
        $keys = EventDocumentPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventDocumentPeer::EVENT_ID)) $criteria->add(EventDocumentPeer::EVENT_ID, $this->event_id);
        if ($this->isColumnModified(EventDocumentPeer::DOCUMENT_ID)) $criteria->add(EventDocumentPeer::DOCUMENT_ID, $this->document_id);
        if ($this->isColumnModified(EventDocumentPeer::SORT)) $criteria->add(EventDocumentPeer::SORT, $this->sort);
        if ($this->isColumnModified(EventDocumentPeer::CREATED_AT)) $criteria->add(EventDocumentPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(EventDocumentPeer::UPDATED_AT)) $criteria->add(EventDocumentPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(EventDocumentPeer::CREATED_BY)) $criteria->add(EventDocumentPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(EventDocumentPeer::UPDATED_BY)) $criteria->add(EventDocumentPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(EventDocumentPeer::DATABASE_NAME);
        $criteria->add(EventDocumentPeer::EVENT_ID, $this->event_id);
        $criteria->add(EventDocumentPeer::DOCUMENT_ID, $this->document_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getEventId()) && (null === $this->getDocumentId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of EventDocument (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EventDocument Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return EventDocumentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EventDocumentPeer();
        }
    ...
    public function getEvent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEvent === null && ($this->event_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEvent->addEventDocuments($this);
             */
        }
    ...
    public function getDocument(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDocument === null && ($this->document_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDocument->addEventDocuments($this);
             */
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addEventDocumentRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCreatedBy->addEventDocumentsRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addEventDocumentRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addEventDocumentsRelatedByUpdatedBy($this);
             */
        }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        $oUser = EventDocumentPeer::getRightsUser($oUser);
        $bIsAllowed = false;
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && EventDocumentPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(EventDocumentPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleEventDocumentOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }

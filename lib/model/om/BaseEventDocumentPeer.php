...
abstract class BaseEventDocumentPeer {
	...
	const CLASS_DEFAULT = 'model.EventDocument';
	...
	/**
	 * An identiy map to hold any loaded instances of EventDocument objects.
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::EVENT_ID, self::DOCUMENT_ID, self::SORT, self::CREATED_AT, self::UPDATED_AT, self::CREATED_BY, self::UPDATED_BY, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::EVENT_ID => 0, self::DOCUMENT_ID => 1, self::SORT => 2, self::CREATED_AT => 3, self::UPDATED_AT => 4, self::CREATED_BY => 5, self::UPDATED_BY => 6, ),
	 ...
	 *
	 * @param      EventDocument $value A EventDocument object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(EventDocument $obj, $key = null)
	{
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = EventDocumentPeer::getOMClass(false);
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = EventDocumentPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + EventDocumentPeer::NUM_COLUMNS;
		} else {
	...
	public static function doSelectJoinEvent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		EventDocumentPeer::addSelectColumns($criteria);
		$startcol = (EventDocumentPeer::NUM_COLUMNS - EventDocumentPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		EventDocumentPeer::addSelectColumns($criteria);
		$startcol2 = (EventDocumentPeer::NUM_COLUMNS - EventDocumentPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	{
		return $withPrefix ? EventDocumentPeer::CLASS_DEFAULT : EventDocumentPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a EventDocument or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a EventDocument or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the event_documents table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a EventDocument or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(EventDocument $obj, $cols = null)
	{
		$columns = array();

...
/**
 * Base static class for performing query and update operations on the 'event_types' table.
 *
 *
 *
...
abstract class BaseEventTypePeer
{
    ...
    const NAME = 'event_types.name';

    /** the column name for the is_externally_managed field */
    const IS_EXTERNALLY_MANAGED = 'event_types.is_externally_managed';

    /** the column name for the created_at field */
    const CREATED_AT = 'event_types.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'event_types.updated_at';

    /** the column name for the created_by field */
    const CREATED_BY = 'event_types.created_by';
    ...
    /**
     * An identity map to hold any loaded instances of EventType objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (EventTypePeer::ID, EventTypePeer::NAME, EventTypePeer::IS_EXTERNALLY_MANAGED, EventTypePeer::CREATED_AT, EventTypePeer::UPDATED_AT, EventTypePeer::CREATED_BY, EventTypePeer::UPDATED_BY, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (EventTypePeer::ID => 0, EventTypePeer::NAME => 1, EventTypePeer::IS_EXTERNALLY_MANAGED => 2, EventTypePeer::CREATED_AT => 3, EventTypePeer::UPDATED_AT => 4, EventTypePeer::CREATED_BY => 5, EventTypePeer::UPDATED_BY => 6, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(EventTypePeer::IS_EXTERNALLY_MANAGED);
            $criteria->addSelectColumn(EventTypePeer::CREATED_AT);
            $criteria->addSelectColumn(EventTypePeer::UPDATED_AT);
            $criteria->addSelectColumn(EventTypePeer::CREATED_BY);
            $criteria->addSelectColumn(EventTypePeer::UPDATED_BY);
        } else {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to event_types
    ...
    /**
     * Selects a collection of EventType objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinUserRelatedByCreatedBy(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (EventType) to $obj2 (User)
                $obj2->addEventTypeRelatedByCreatedBy($obj1);
    ...
    public static function doSelectJoinUserRelatedByUpdatedBy(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (EventType) to $obj2 (User)
                $obj2->addEventTypeRelatedByUpdatedBy($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (EventType) to the collection in $obj2 (User)
                $obj2->addEventTypeRelatedByCreatedBy($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (EventType) to the collection in $obj3 (User)
                $obj3->addEventTypeRelatedByUpdatedBy($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of EventType objects pre-filled with all related objects except UserRelatedByCreatedBy.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of EventType objects pre-filled with all related objects except UserRelatedByUpdatedBy.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN

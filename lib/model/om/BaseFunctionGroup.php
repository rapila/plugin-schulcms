...
/**
 * Base class that represents a row from the 'function_groups' table.
 *
 * 
 *
 * @package    propel.generator.model.om
 */
abstract class BaseFunctionGroup extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'FunctionGroupPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        FunctionGroupPeer
	 */
	...
	/**
	 * @var        array SchoolFunction[] Collection to store aggregation of SchoolFunction objects.
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = FunctionGroupPeer::ID;
		}
	...
	public function setOriginalName($v)
	{
		...
		if ($this->original_name !== $v) {
			...
			$this->modifiedColumns[] = FunctionGroupPeer::ORIGINAL_NAME;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = FunctionGroupPeer::NAME;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = FunctionGroupPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = FunctionGroupPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = FunctionGroupPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = FunctionGroupPeer::UPDATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = FunctionGroupPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating FunctionGroup object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = FunctionGroupPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = FunctionGroupQuery::create()
				->filterByPrimaryKey($this->getPrimaryKey());
			$ret = $this->preDelete($con);
			// denyable behavior
			if(!(FunctionGroupPeer::isIgnoringRights() || $this->mayOperate("delete"))) {
				throw new PropelException(new NotPermittedException("delete.by_role", array("role_key" => "function_groups")));
			}
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// denyable behavior
				if(!(FunctionGroupPeer::isIgnoringRights() || $this->mayOperate("insert"))) {
					throw new PropelException(new NotPermittedException("insert.by_role", array("role_key" => "function_groups")));
				}

				// extended_timestampable behavior
				if (!$this->isColumnModified(FunctionGroupPeer::CREATED_AT)) {
					$this->setCreatedAt(time());
				}
				if (!$this->isColumnModified(FunctionGroupPeer::UPDATED_AT)) {
					$this->setUpdatedAt(time());
				}
				// attributable behavior
				
				if(Session::getSession()->isAuthenticated()) {
					if (!$this->isColumnModified(FunctionGroupPeer::CREATED_BY)) {
						$this->setCreatedBy(Session::getSession()->getUser()->getId());
					}
					if (!$this->isColumnModified(FunctionGroupPeer::UPDATED_BY)) {
				...
				// denyable behavior
				if(!(FunctionGroupPeer::isIgnoringRights() || $this->mayOperate("update"))) {
					throw new PropelException(new NotPermittedException("update.by_role", array("role_key" => "function_groups")));
				}

				// extended_timestampable behavior
				if ($this->isModified() && !$this->isColumnModified(FunctionGroupPeer::UPDATED_AT)) {
					$this->setUpdatedAt(time());
				}
				// attributable behavior
				
				if(Session::getSession()->isAuthenticated()) {
					if ($this->isModified() && !$this->isColumnModified(FunctionGroupPeer::UPDATED_BY)) {
						$this->setUpdatedBy(Session::getSession()->getUser()->getId());
					}
				}
			}
			if ($ret) {
				...
				$this->postSave($con);
				FunctionGroupPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(FunctionGroupPeer::ID)) {
		...
		$sql = sprintf(
			'INSERT INTO `function_groups` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = FunctionGroupPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = FunctionGroupPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['FunctionGroup'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['FunctionGroup'][$this->getPrimaryKey()] = true;
		$keys = FunctionGroupPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FunctionGroupPeer::CREATED_BY)) $criteria->add(FunctionGroupPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(FunctionGroupPeer::UPDATED_BY)) $criteria->add(FunctionGroupPeer::UPDATED_BY, $this->updated_by);
	...
	{
		$criteria = new Criteria(FunctionGroupPeer::DATABASE_NAME);
		$criteria->add(FunctionGroupPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of FunctionGroup (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     FunctionGroup Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     FunctionGroupPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new FunctionGroupPeer();
		}
		return self::$peer;
	}
	...
	public function setUserRelatedByCreatedBy(User $v = null)
	{
		...
		if ($v !== null) {
			$v->addFunctionGroupRelatedByCreatedBy($this);
		}
	...
	public function getUserRelatedByCreatedBy(PropelPDO $con = null)
	{
		if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aUserRelatedByCreatedBy->addFunctionGroupsRelatedByCreatedBy($this);
			 */
		}
	...
	public function setUserRelatedByUpdatedBy(User $v = null)
	{
		...
		// If this object has already been added to the User object, it will not be re-added.
		if ($v !== null) {
			$v->addFunctionGroupRelatedByUpdatedBy($this);
		}
	...
	public function getUserRelatedByUpdatedBy(PropelPDO $con = null)
	{
		if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aUserRelatedByUpdatedBy->addFunctionGroupsRelatedByUpdatedBy($this);
			 */
		}
	...
	public function initRelation($relationName)
	{
		if ('SchoolFunction' == $relationName) {
			return $this->initSchoolFunctions();
		}
	}
	 ...
	 * If this FunctionGroup is new, it will return
	 * an empty collection or the current collection; the criteria is ignored on a new object.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array SchoolFunction[] List of SchoolFunction objects
	 * @throws     PropelException
	 */
	public function getSchoolFunctions($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collSchoolFunctions || null !== $criteria) {
	...
	{
		$this->schoolFunctionsScheduledForDeletion = $this->getSchoolFunctions(new Criteria(), $con)->diff($schoolFunctions);

		foreach ($schoolFunctions as $schoolFunction) {
			// Fix issue with collection modified by reference
			if ($schoolFunction->isNew()) {
				$schoolFunction->setFunctionGroup($this);
			}
	...
	public function addSchoolFunction(SchoolFunction $l)
	{
		...
		if (!$this->collSchoolFunctions->contains($l)) { // only add it if the **same** object is not already associated
	 ...
	 * Otherwise if this FunctionGroup is new, it will return
	 * an empty collection; or if this FunctionGroup has previously
	 * been saved, it will retrieve related SchoolFunctions from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in FunctionGroup.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array SchoolFunction[] List of SchoolFunction objects
	 */
	public function getSchoolFunctionsJoinSchool($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = SchoolFunctionQuery::create(null, $criteria);
	...
	{
		return (string) $this->exportTo(FunctionGroupPeer::DEFAULT_STRING_FORMAT);
	}
	...
	public function mayOperate($sOperation, $oUser = false) {
		...
		if(FunctionGroupPeer::mayOperateOn($oUser, $this, $sOperation)) {
			return true;
		}
		$bIsAllowed = false;

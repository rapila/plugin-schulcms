...
abstract class BaseFunctionGroup extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = FunctionGroupPeer::NUM_COLUMNS - FunctionGroupPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setNameNormalized($this->name_normalized);
	 ...
	 * @return     void
	 */
	public function initSchoolFunctions()
	{
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collSchoolFunctions) {
				foreach ((array) $this->collSchoolFunctions as $o) {

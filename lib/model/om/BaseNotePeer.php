...
abstract class BaseNotePeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Body', 'DateStart', 'DateEnd', 'CreatedAt', 'UpdatedAt', 'CreatedBy', 'UpdatedBy', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'body', 'dateStart', 'dateEnd', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::BODY, self::DATE_START, self::DATE_END, self::CREATED_AT, self::UPDATED_AT, self::CREATED_BY, self::UPDATED_BY, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'BODY', 'DATE_START', 'DATE_END', 'CREATED_AT', 'UPDATED_AT', 'CREATED_BY', 'UPDATED_BY', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'body', 'date_start', 'date_end', 'created_at', 'updated_at', 'created_by', 'updated_by', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Body' => 1, 'DateStart' => 2, 'DateEnd' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, 'CreatedBy' => 6, 'UpdatedBy' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'body' => 1, 'dateStart' => 2, 'dateEnd' => 3, 'createdAt' => 4, 'updatedAt' => 5, 'createdBy' => 6, 'updatedBy' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::BODY => 1, self::DATE_START => 2, self::DATE_END => 3, self::CREATED_AT => 4, self::UPDATED_AT => 5, self::CREATED_BY => 6, self::UPDATED_BY => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'BODY' => 1, 'DATE_START' => 2, 'DATE_END' => 3, 'CREATED_AT' => 4, 'UPDATED_AT' => 5, 'CREATED_BY' => 6, 'UPDATED_BY' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'body' => 1, 'date_start' => 2, 'date_end' => 3, 'created_at' => 4, 'updated_at' => 5, 'created_by' => 6, 'updated_by' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);

...
abstract class BaseNotePeer
{
    ...
    /**
     * An identity map to hold any loaded instances of Note objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (NotePeer::ID, NotePeer::NOTE_TYPE_ID, NotePeer::BODY, NotePeer::DATE_START, NotePeer::DATE_END, NotePeer::IS_INACTIVE, NotePeer::IMAGE_ID, NotePeer::CREATED_AT, NotePeer::UPDATED_AT, NotePeer::CREATED_BY, NotePeer::UPDATED_BY, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (NotePeer::ID => 0, NotePeer::NOTE_TYPE_ID => 1, NotePeer::BODY => 2, NotePeer::DATE_START => 3, NotePeer::DATE_END => 4, NotePeer::IS_INACTIVE => 5, NotePeer::IMAGE_ID => 6, NotePeer::CREATED_AT => 7, NotePeer::UPDATED_AT => 8, NotePeer::CREATED_BY => 9, NotePeer::UPDATED_BY => 10, ),
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (NotePeer::$instances as $instance) {

...
abstract class BaseNoteTypePeer
{
     ...
     * e.g. NoteTypePeer::$fieldNames[NoteTypePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (NoteTypePeer::ID, NoteTypePeer::NAME, NoteTypePeer::CREATED_AT, NoteTypePeer::UPDATED_AT, NoteTypePeer::CREATED_BY, NoteTypePeer::UPDATED_BY, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. NoteTypePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (NoteTypePeer::ID => 0, NoteTypePeer::NAME => 1, NoteTypePeer::CREATED_AT => 2, NoteTypePeer::UPDATED_AT => 3, NoteTypePeer::CREATED_BY => 4, NoteTypePeer::UPDATED_BY => 5, ),
    ...
    {
        $toNames = NoteTypePeer::getFieldNames($toType);
        $key = isset(NoteTypePeer::$fieldKeys[$fromType][$name]) ? NoteTypePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(NoteTypePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, NoteTypePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return NoteTypePeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(NoteTypePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(NoteTypePeer::DATABASE_NAME);
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            NoteTypePeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(NoteTypePeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(NoteTypePeer::$instances[$key])) {
                return NoteTypePeer::$instances[$key];
            }
        }
    ...
    {
        return Propel::getDatabaseMap(NoteTypePeer::DATABASE_NAME)->getTable(NoteTypePeer::TABLE_NAME);
    }

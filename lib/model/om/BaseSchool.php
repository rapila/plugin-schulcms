...
abstract class BaseSchool extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 14; // 14 = SchoolPeer::NUM_COLUMNS - SchoolPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setSchoolUnit($this->school_unit);
		$copyObj->setAddress($this->address);
		$copyObj->setZipCode($this->zip_code);
		$copyObj->setCity($this->city);
		$copyObj->setPhoneSchulleitung($this->phone_schulleitung);
		$copyObj->setPhoneLehrerzimmer($this->phone_lehrerzimmer);
		$copyObj->setCurrentYear($this->current_year);

...
abstract class BaseSchoolBuilding extends BaseObject implements Persistent
{
    ...
    public function removeSchoolClass($schoolClass)
    {
        if ($this->getSchoolClasss()->contains($schoolClass)) {
            ...
            $schoolClass->setSchoolBuilding(null);
        }
     ...
     * @return PropelObjectCollection|SchoolClass[] List of SchoolClass objects
     */
    public function getSchoolClasssJoinSchoolClassRelatedByAncestorClassId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SchoolClassQuery::create(null, $criteria);
        $query->joinWith('SchoolClassRelatedByAncestorClassId', $join_behavior);
     ...
     * @return PropelObjectCollection|SchoolClass[] List of SchoolClass objects
     */
    public function getSchoolClasssJoinSubject($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SchoolClassQuery::create(null, $criteria);

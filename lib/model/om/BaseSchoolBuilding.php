...
/**
 * Base class that represents a row from the 'school_buildings' table.
 *
 * 
 *
 * @package    propel.generator.model.om
 */
abstract class BaseSchoolBuilding extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'SchoolBuildingPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        SchoolBuildingPeer
	 */
	...
	/**
	 * @var        array SchoolClass[] Collection to store aggregation of SchoolClass objects.
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SchoolBuildingPeer::ID;
		}
	...
	public function setOriginalId($v)
	{
		...
		if ($this->original_id !== $v) {
			$this->original_id = $v;
			$this->modifiedColumns[] = SchoolBuildingPeer::ORIGINAL_ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = SchoolBuildingPeer::NAME;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = SchoolBuildingPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = SchoolBuildingPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = SchoolBuildingPeer::CREATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			throw new PropelException("Error populating SchoolBuilding object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SchoolBuildingPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				if (!$this->isColumnModified(SchoolBuildingPeer::UPDATED_AT)) {
					$this->setUpdatedAt(time());
				}
				// attributable behavior
				
				if(Session::getSession()->isAuthenticated()) {
					if (!$this->isColumnModified(SchoolBuildingPeer::CREATED_BY)) {
						$this->setCreatedBy(Session::getSession()->getUser()->getId());
					}
					if (!$this->isColumnModified(SchoolBuildingPeer::UPDATED_BY)) {
				...
				if(Session::getSession()->isAuthenticated()) {
					if ($this->isModified() && !$this->isColumnModified(SchoolBuildingPeer::UPDATED_BY)) {
						$this->setUpdatedBy(Session::getSession()->getUser()->getId());
					}
				}
			}
			if ($ret) {
				...
				$this->postSave($con);
				SchoolBuildingPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(SchoolBuildingPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(SchoolBuildingPeer::ORIGINAL_ID)) {
			$modifiedColumns[':p' . $index++]  = '`ORIGINAL_ID`';
		}
		if ($this->isColumnModified(SchoolBuildingPeer::NAME)) {
		...
		$sql = sprintf(
			'INSERT INTO `school_buildings` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SchoolBuildingPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SchoolBuildingPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['SchoolBuilding'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['SchoolBuilding'][$this->getPrimaryKey()] = true;
		$keys = SchoolBuildingPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SchoolBuildingPeer::ID)) $criteria->add(SchoolBuildingPeer::ID, $this->id);
		if ($this->isColumnModified(SchoolBuildingPeer::ORIGINAL_ID)) $criteria->add(SchoolBuildingPeer::ORIGINAL_ID, $this->original_id);
		if ($this->isColumnModified(SchoolBuildingPeer::NAME)) $criteria->add(SchoolBuildingPeer::NAME, $this->name);
		if ($this->isColumnModified(SchoolBuildingPeer::CREATED_AT)) $criteria->add(SchoolBuildingPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(SchoolBuildingPeer::UPDATED_AT)) $criteria->add(SchoolBuildingPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(SchoolBuildingPeer::CREATED_BY)) $criteria->add(SchoolBuildingPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(SchoolBuildingPeer::UPDATED_BY)) $criteria->add(SchoolBuildingPeer::UPDATED_BY, $this->updated_by);
	...
	{
		$criteria = new Criteria(SchoolBuildingPeer::DATABASE_NAME);
		$criteria->add(SchoolBuildingPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SchoolBuilding (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SchoolBuilding Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SchoolBuildingPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SchoolBuildingPeer();
		}
		return self::$peer;
	}
	...
	public function setUserRelatedByCreatedBy(User $v = null)
	{
		...
		if ($v !== null) {
			$v->addSchoolBuildingRelatedByCreatedBy($this);
		}
	...
	public function getUserRelatedByCreatedBy(PropelPDO $con = null)
	{
		if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aUserRelatedByCreatedBy->addSchoolBuildingsRelatedByCreatedBy($this);
			 */
		}
	...
	public function setUserRelatedByUpdatedBy(User $v = null)
	{
		...
		// If this object has already been added to the User object, it will not be re-added.
		if ($v !== null) {
			$v->addSchoolBuildingRelatedByUpdatedBy($this);
		}
	...
	public function getUserRelatedByUpdatedBy(PropelPDO $con = null)
	{
		if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aUserRelatedByUpdatedBy->addSchoolBuildingsRelatedByUpdatedBy($this);
			 */
		}
	...
	{
		$this->schoolClasssScheduledForDeletion = $this->getSchoolClasss(new Criteria(), $con)->diff($schoolClasss);

		foreach ($schoolClasss as $schoolClass) {
			// Fix issue with collection modified by reference
			if ($schoolClass->isNew()) {
				$schoolClass->setSchoolBuilding($this);
			}
	...
	public function addSchoolClass(SchoolClass $l)
	{
		...
		if (!$this->collSchoolClasss->contains($l)) { // only add it if the **same** object is not already associated
	 ...
	 * Otherwise if this SchoolBuilding is new, it will return
	 * an empty collection; or if this SchoolBuilding has previously
	 * been saved, it will retrieve related SchoolClasss from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in SchoolBuilding.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	...
	public function mayOperate($sOperation, $oUser = false) {
		...
		if(SchoolBuildingPeer::mayOperateOn($oUser, $this, $sOperation)) {
			return true;
		}
		$bIsAllowed = false;

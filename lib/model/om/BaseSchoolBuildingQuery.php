...
abstract class BaseSchoolBuildingQuery extends ModelCriteria
{
     ...
     * @param   SchoolBuildingQuery|Criteria $criteria Optional Criteria to build the query from
     *
    ...
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new SchoolBuildingQuery(null, null, $modelAlias);
     ...
     *
     * @return   SchoolBuilding|SchoolBuilding[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = SchoolBuildingPeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return                 SchoolBuilding A model object, or null if the key is not found
    ...
    {
        $sql = 'SELECT `id`, `original_id`, `name`, `created_at`, `updated_at`, `created_by`, `updated_by` FROM `school_buildings` WHERE `id` = :p0';
        try {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $obj = new SchoolBuilding();
            $obj->hydrate($row);
            SchoolBuildingPeer::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|SchoolBuilding[]|mixed the list of results, formatted by the current formatter
     */
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(SchoolBuildingPeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(SchoolBuildingPeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByUserRelatedByCreatedBy($user, $comparison = null)
    {
        if ($user instanceof User) {
            ...
            return $this
                ->addUsingAlias(SchoolBuildingPeer::CREATED_BY, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByUserRelatedByUpdatedBy($user, $comparison = null)
    {
        if ($user instanceof User) {
            ...
            return $this
                ->addUsingAlias(SchoolBuildingPeer::UPDATED_BY, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {

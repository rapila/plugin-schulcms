...
abstract class BaseSchoolClass extends BaseObject  implements Persistent
{
	...
	/**
	 * @var        array ClassStudent[] Collection to store aggregation of ClassStudent objects.
	 */
	protected $collClassStudents;

	/**
	 * @var        array ClassLink[] Collection to store aggregation of ClassLink objects.
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->class_portrait_id = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->class_type_id = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
			$this->class_schedule_id = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
			$this->week_schedule_id = ($row[$startcol + 12] !== null) ? (int) $row[$startcol + 12] : null;
			$this->school_building_id = ($row[$startcol + 13] !== null) ? (int) $row[$startcol + 13] : null;
			$this->school_id = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[9] => $this->getClassPortraitId(),
			$keys[10] => $this->getClassTypeId(),
			$keys[11] => $this->getClassScheduleId(),
			$keys[12] => $this->getWeekScheduleId(),
			$keys[13] => $this->getSchoolBuildingId(),
			$keys[14] => $this->getSchoolId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[9], $arr)) $this->setClassPortraitId($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setClassTypeId($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setClassScheduleId($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setWeekScheduleId($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setSchoolBuildingId($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setSchoolId($arr[$keys[14]]);
	 ...
	 * @throws     PropelException
	 */
	public function getDocumentRelatedByClassPortraitId(PropelPDO $con = null)
	{
	 ...
	 * @throws     PropelException
	 */
	public function getClassType(PropelPDO $con = null)
	{
	 ...
	 * @throws     PropelException
	 */
	public function getDocumentRelatedByClassScheduleId(PropelPDO $con = null)
	{
	 ...
	 * @throws     PropelException
	 */
	public function getDocumentRelatedByWeekScheduleId(PropelPDO $con = null)
	{
	 ...
	 * @throws     PropelException
	 */
	public function getSchoolBuilding(PropelPDO $con = null)
	{
	 ...
	 * @return     PropelCollection|array ClassStudent[] List of ClassStudent objects
	 * @throws     PropelException
	 */
	public function getClassStudents($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collClassStudents || null !== $criteria) {
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array ClassLink[] List of ClassLink objects
	 * @throws     PropelException
	 */
	public function getClassLinks($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collClassLinks || null !== $criteria) {
	...
	public function mayOperate($sOperation, $oUser = false) {
		...
		return SchoolClassPeer::mayOperateOn($oUser, $this, $sOperation);
	}

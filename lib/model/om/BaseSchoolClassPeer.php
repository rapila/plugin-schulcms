...
abstract class BaseSchoolClassPeer {
	 ...
	 */
	public static function addInstanceToPool(SchoolClass $obj, $key = null)
	{
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = SchoolClassPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + SchoolClassPeer::NUM_COLUMNS;
		} else {
	...
	public static function doSelectJoinDocumentRelatedByClassPortraitId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		SchoolClassPeer::addSelectColumns($criteria);
		$startcol = (SchoolClassPeer::NUM_COLUMNS - SchoolClassPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		SchoolClassPeer::addSelectColumns($criteria);
		$startcol2 = (SchoolClassPeer::NUM_COLUMNS - SchoolClassPeer::NUM_LAZY_LOAD_COLUMNS);

		DocumentPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (DocumentPeer::NUM_COLUMNS - DocumentPeer::NUM_LAZY_LOAD_COLUMNS);

		ClassTypePeer::addSelectColumns($criteria);
		$startcol4 = $startcol3 + (ClassTypePeer::NUM_COLUMNS - ClassTypePeer::NUM_LAZY_LOAD_COLUMNS);

		DocumentPeer::addSelectColumns($criteria);
		$startcol5 = $startcol4 + (DocumentPeer::NUM_COLUMNS - DocumentPeer::NUM_LAZY_LOAD_COLUMNS);

		DocumentPeer::addSelectColumns($criteria);
		$startcol6 = $startcol5 + (DocumentPeer::NUM_COLUMNS - DocumentPeer::NUM_LAZY_LOAD_COLUMNS);

		SchoolBuildingPeer::addSelectColumns($criteria);
		$startcol7 = $startcol6 + (SchoolBuildingPeer::NUM_COLUMNS - SchoolBuildingPeer::NUM_LAZY_LOAD_COLUMNS);

		SchoolPeer::addSelectColumns($criteria);
		$startcol8 = $startcol7 + (SchoolPeer::NUM_COLUMNS - SchoolPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAllExceptDocumentRelatedByClassPortraitId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ClassTypePeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (ClassTypePeer::NUM_COLUMNS - ClassTypePeer::NUM_LAZY_LOAD_COLUMNS);

		SchoolBuildingPeer::addSelectColumns($criteria);
		$startcol4 = $startcol3 + (SchoolBuildingPeer::NUM_COLUMNS - SchoolBuildingPeer::NUM_LAZY_LOAD_COLUMNS);

		SchoolPeer::addSelectColumns($criteria);
		$startcol5 = $startcol4 + (SchoolPeer::NUM_COLUMNS - SchoolPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAllExceptClassType(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		SchoolBuildingPeer::addSelectColumns($criteria);
		$startcol6 = $startcol5 + (SchoolBuildingPeer::NUM_COLUMNS - SchoolBuildingPeer::NUM_LAZY_LOAD_COLUMNS);

		SchoolPeer::addSelectColumns($criteria);
		$startcol7 = $startcol6 + (SchoolPeer::NUM_COLUMNS - SchoolPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	/**
	 * Method perform an INSERT on the database, given a SchoolClass or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a SchoolClass or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the school_classes table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a SchoolClass or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(SchoolClass $obj, $cols = null)
	{
		$columns = array();

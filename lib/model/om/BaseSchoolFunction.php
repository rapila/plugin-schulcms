...
abstract class BaseSchoolFunction extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 9; // 9 = SchoolFunctionPeer::NUM_COLUMNS - SchoolFunctionPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(SchoolFunctionPeer::ID) ) {
					...
					$affectedRows += SchoolFunctionPeer::doUpdate($this, $con);
				}
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		if ($includeForeignObjects) {
			if (null !== $this->aFunctionGroup) {
				$result['FunctionGroup'] = $this->aFunctionGroup->toArray($keyType, $includeLazyLoadColumns, true);
			}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setFunctionGroupId($this->function_group_id);
	 ...
	 * @throws     PropelException
	 */
	public function getFunctionGroup(PropelPDO $con = null)
	{
		if ($this->aFunctionGroup === null && ($this->function_group_id !== null)) {

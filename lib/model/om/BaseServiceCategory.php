...
/**
 * Base class that represents a row from the 'service_categories' table.
 *
 * 
 *
 * @package    propel.generator.model.om
 */
abstract class BaseServiceCategory extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'ServiceCategoryPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ServiceCategoryPeer
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ServiceCategoryPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = ServiceCategoryPeer::NAME;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = ServiceCategoryPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = ServiceCategoryPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = ServiceCategoryPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = ServiceCategoryPeer::UPDATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = ServiceCategoryPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating ServiceCategory object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ServiceCategoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = ServiceCategoryQuery::create()
				->filterByPrimaryKey($this->getPrimaryKey());
			$ret = $this->preDelete($con);
			// denyable behavior
			if(!(ServiceCategoryPeer::isIgnoringRights() || $this->mayOperate("delete"))) {
				throw new PropelException(new NotPermittedException("delete.by_role", array("role_key" => "service_categories")));
			}
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// denyable behavior
				if(!(ServiceCategoryPeer::isIgnoringRights() || $this->mayOperate("insert"))) {
					throw new PropelException(new NotPermittedException("insert.by_role", array("role_key" => "service_categories")));
				}
				...
				if (!$this->isColumnModified(ServiceCategoryPeer::UPDATED_AT)) {
					$this->setUpdatedAt(time());
				}
				// attributable behavior
				
				if(Session::getSession()->isAuthenticated()) {
					if (!$this->isColumnModified(ServiceCategoryPeer::CREATED_BY)) {
						$this->setCreatedBy(Session::getSession()->getUser()->getId());
					}
					if (!$this->isColumnModified(ServiceCategoryPeer::UPDATED_BY)) {
				...
				// denyable behavior
				if(!(ServiceCategoryPeer::isIgnoringRights() || $this->mayOperate("update"))) {
					throw new PropelException(new NotPermittedException("update.by_role", array("role_key" => "service_categories")));
				}

				// extended_timestampable behavior
				if ($this->isModified() && !$this->isColumnModified(ServiceCategoryPeer::UPDATED_AT)) {
					$this->setUpdatedAt(time());
				}
				// attributable behavior
				
				if(Session::getSession()->isAuthenticated()) {
					if ($this->isModified() && !$this->isColumnModified(ServiceCategoryPeer::UPDATED_BY)) {
						$this->setUpdatedBy(Session::getSession()->getUser()->getId());
					}
				}
			}
			if ($ret) {
				...
				$this->postSave($con);
				ServiceCategoryPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(ServiceCategoryPeer::ID) ) {
					...
					$affectedRows += ServiceCategoryPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ServiceCategoryPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ServiceCategoryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['ServiceCategory'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['ServiceCategory'][$this->getPrimaryKey()] = true;
		$keys = ServiceCategoryPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ServiceCategoryPeer::UPDATED_BY)) $criteria->add(ServiceCategoryPeer::UPDATED_BY, $this->updated_by);
	...
	{
		$criteria = new Criteria(ServiceCategoryPeer::DATABASE_NAME);
		$criteria->add(ServiceCategoryPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ServiceCategory (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ServiceCategory Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ServiceCategoryPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ServiceCategoryPeer();
		}
		return self::$peer;
	}
	...
	public function setUserRelatedByCreatedBy(User $v = null)
	{
		...
		if ($v !== null) {
			$v->addServiceCategoryRelatedByCreatedBy($this);
		}
	...
	public function getUserRelatedByCreatedBy(PropelPDO $con = null)
	{
		if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aUserRelatedByCreatedBy->addServiceCategorysRelatedByCreatedBy($this);
			 */
		}
	...
	public function setUserRelatedByUpdatedBy(User $v = null)
	{
		...
		// If this object has already been added to the User object, it will not be re-added.
		if ($v !== null) {
			$v->addServiceCategoryRelatedByUpdatedBy($this);
		}
	...
	public function getUserRelatedByUpdatedBy(PropelPDO $con = null)
	{
		if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aUserRelatedByUpdatedBy->addServiceCategorysRelatedByUpdatedBy($this);
			 */
		}
	...
	public function addService(Service $l)
	{
		...
		if (!$this->collServices->contains($l)) { // only add it if the **same** object is not already associated
			$this->collServices[]= $l;
			$l->setServiceCategory($this);
		}
	 ...
	 * Otherwise if this ServiceCategory is new, it will return
	 * an empty collection; or if this ServiceCategory has previously
	 * been saved, it will retrieve related Services from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in ServiceCategory.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array Service[] List of Service objects
	 */
	public function getServicesJoinDocument($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ServiceQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array Service[] List of Service objects
	 */
	public function getServicesJoinUserRelatedByCreatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ServiceQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array Service[] List of Service objects
	 */
	public function getServicesJoinUserRelatedByUpdatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ServiceQuery::create(null, $criteria);
	...
	{
		return (string) $this->exportTo(ServiceCategoryPeer::DEFAULT_STRING_FORMAT);
	}
	...
	public function mayOperate($sOperation, $oUser = false) {
		...
		if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && ServiceCategoryPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
			return true;
		}
		return ServiceCategoryPeer::mayOperateOn($oUser, $this, $sOperation);
	}

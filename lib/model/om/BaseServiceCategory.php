...
abstract class BaseServiceCategory extends BaseObject  implements Persistent
{
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(ServiceCategoryPeer::ID)) {
		...
		$sql = sprintf(
			'INSERT INTO `service_categories` (%s) VALUES (%s)',
	...
	{
		$this->servicesScheduledForDeletion = $this->getServices(new Criteria(), $con)->diff($services);
	...
	public function mayOperate($sOperation, $oUser = false) {
		...
		if(ServiceCategoryPeer::mayOperateOn($oUser, $this, $sOperation)) {
			return true;
		}
		$bIsAllowed = false;

...
/**
 * Base class that represents a row from the 'service_documents' table.
 *
 *
 *
 * @package    propel.generator.model.om
 */
abstract class BaseServiceDocument extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ServiceDocumentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ServiceDocumentPeer
     */
    ...
    public function setServiceId($v)
    {
        ...
        if ($this->service_id !== $v) {
            $this->service_id = $v;
            $this->modifiedColumns[] = ServiceDocumentPeer::SERVICE_ID;
        }
    ...
    public function setDocumentId($v)
    {
        ...
        if ($this->document_id !== $v) {
            $this->document_id = $v;
            $this->modifiedColumns[] = ServiceDocumentPeer::DOCUMENT_ID;
        }
    ...
    public function setSort($v)
    {
        ...
        if ($this->sort !== $v) {
            $this->sort = $v;
            $this->modifiedColumns[] = ServiceDocumentPeer::SORT;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ServiceDocumentPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ServiceDocumentPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = ServiceDocumentPeer::CREATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            throw new PropelException("Error populating ServiceDocument object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ServiceDocumentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ServiceDocumentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ServiceDocumentPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ServiceDocumentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if (!$this->isColumnModified(ServiceDocumentPeer::CREATED_BY)) {
                        $this->setCreatedBy(Session::getSession()->getUser()->getId());
                    }
                    if (!$this->isColumnModified(ServiceDocumentPeer::UPDATED_BY)) {
                ...
                // extended_timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ServiceDocumentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(ServiceDocumentPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                ServiceDocumentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ServiceDocumentPeer::SERVICE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`service_id`';
        }
        if ($this->isColumnModified(ServiceDocumentPeer::DOCUMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`document_id`';
        }
        if ($this->isColumnModified(ServiceDocumentPeer::SORT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `service_documents` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ServiceDocumentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ServiceDocumentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ServiceDocument'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ServiceDocument'][serialize($this->getPrimaryKey())] = true;
        $keys = ServiceDocumentPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ServiceDocumentPeer::SERVICE_ID)) $criteria->add(ServiceDocumentPeer::SERVICE_ID, $this->service_id);
        if ($this->isColumnModified(ServiceDocumentPeer::DOCUMENT_ID)) $criteria->add(ServiceDocumentPeer::DOCUMENT_ID, $this->document_id);
        if ($this->isColumnModified(ServiceDocumentPeer::SORT)) $criteria->add(ServiceDocumentPeer::SORT, $this->sort);
        if ($this->isColumnModified(ServiceDocumentPeer::CREATED_AT)) $criteria->add(ServiceDocumentPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ServiceDocumentPeer::UPDATED_AT)) $criteria->add(ServiceDocumentPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(ServiceDocumentPeer::CREATED_BY)) $criteria->add(ServiceDocumentPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(ServiceDocumentPeer::UPDATED_BY)) $criteria->add(ServiceDocumentPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(ServiceDocumentPeer::DATABASE_NAME);
        $criteria->add(ServiceDocumentPeer::SERVICE_ID, $this->service_id);
        $criteria->add(ServiceDocumentPeer::DOCUMENT_ID, $this->document_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getServiceId()) && (null === $this->getDocumentId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ServiceDocument (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ServiceDocument Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ServiceDocumentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ServiceDocumentPeer();
        }
    ...
    public function getService(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aService === null && ($this->service_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aService->addServiceDocuments($this);
             */
        }
    ...
    public function getDocument(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDocument === null && ($this->document_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDocument->addServiceDocuments($this);
             */
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addServiceDocumentRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCreatedBy->addServiceDocumentsRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addServiceDocumentRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addServiceDocumentsRelatedByUpdatedBy($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ServiceDocumentPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        $bIsAllowed = false;
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && ServiceDocumentPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(ServiceDocumentPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleServiceDocumentOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }

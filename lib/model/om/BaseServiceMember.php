...
/**
 * Base class that represents a row from the 'service_members' table.
 *
 *
 *
 * @package    propel.generator.model.om
 */
abstract class BaseServiceMember extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ServiceMemberPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ServiceMemberPeer
     */
    ...
    public function setServiceId($v)
    {
        ...
        if ($this->service_id !== $v) {
            $this->service_id = $v;
            $this->modifiedColumns[] = ServiceMemberPeer::SERVICE_ID;
        }
    ...
    public function setFunctionName($v)
    {
        ...
        if ($this->function_name !== $v) {
            ...
            $this->modifiedColumns[] = ServiceMemberPeer::FUNCTION_NAME;
        }
    ...
    public function setTeamMemberId($v)
    {
        ...
        if ($this->team_member_id !== $v) {
            ...
            $this->modifiedColumns[] = ServiceMemberPeer::TEAM_MEMBER_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ServiceMemberPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ServiceMemberPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = ServiceMemberPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = ServiceMemberPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 8; // 8 = ServiceMemberPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ServiceMemberPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ServiceMemberQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // denyable behavior
            if(!(ServiceMemberPeer::isIgnoringRights() || $this->mayOperate("delete"))) {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // denyable behavior
                if(!(ServiceMemberPeer::isIgnoringRights() || $this->mayOperate("insert"))) {
                    throw new PropelException(new NotPermittedException("insert.by_role", array("role_key" => "services")));
                }

                // extended_timestampable behavior
                if (!$this->isColumnModified(ServiceMemberPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ServiceMemberPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if (!$this->isColumnModified(ServiceMemberPeer::CREATED_BY)) {
                        $this->setCreatedBy(Session::getSession()->getUser()->getId());
                    }
                    if (!$this->isColumnModified(ServiceMemberPeer::UPDATED_BY)) {
                ...
                // denyable behavior
                if(!(ServiceMemberPeer::isIgnoringRights() || $this->mayOperate("update"))) {
                    throw new PropelException(new NotPermittedException("update.by_role", array("role_key" => "services")));
                }

                // extended_timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ServiceMemberPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(ServiceMemberPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                ServiceMemberPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ServiceMemberPeer::SERVICE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`service_id`';
        }
        if ($this->isColumnModified(ServiceMemberPeer::FUNCTION_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`function_name`';
        }
        if ($this->isColumnModified(ServiceMemberPeer::TEAM_MEMBER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`team_member_id`';
        }
        if ($this->isColumnModified(ServiceMemberPeer::SORT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `service_members` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ServiceMemberPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ServiceMemberPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ServiceMember'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ServiceMember'][serialize($this->getPrimaryKey())] = true;
        $keys = ServiceMemberPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ServiceMemberPeer::UPDATED_BY)) $criteria->add(ServiceMemberPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(ServiceMemberPeer::DATABASE_NAME);
        $criteria->add(ServiceMemberPeer::SERVICE_ID, $this->service_id);
        $criteria->add(ServiceMemberPeer::TEAM_MEMBER_ID, $this->team_member_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getServiceId()) && (null === $this->getTeamMemberId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ServiceMember (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ServiceMember Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ServiceMemberPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ServiceMemberPeer();
        }
    ...
    public function getService(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aService === null && ($this->service_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aService->addServiceMembers($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function getTeamMember(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTeamMember === null && ($this->team_member_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTeamMember->addServiceMembers($this);
             */
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addServiceMemberRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCreatedBy->addServiceMembersRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addServiceMemberRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addServiceMembersRelatedByUpdatedBy($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aTeamMember instanceof Persistent) {
              $this->aTeamMember->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(ServiceMemberPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        $bIsAllowed = false;
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && ServiceMemberPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(ServiceMemberPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleServiceMemberOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }

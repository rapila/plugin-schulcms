...
abstract class BaseServiceQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `name`, `slug`, `address`, `opening_hours`, `phone`, `email`, `website`, `body`, `body_short`, `is_active`, `logo_id`, `service_category_id`, `created_at`, `updated_at`, `created_by`, `updated_by` FROM `services` WHERE `id` = :p0';
        try {

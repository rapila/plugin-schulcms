...
abstract class BaseTeamMemberFunction extends BaseObject implements Persistent
{
    ...
    /**
     * Sets the value of the [is_main_function] column.
    ...
    public function setIsNewlyUpdated($v)
    {
        ...
        if ($this->is_newly_updated !== $v) {
            ...
            $this->modifiedColumns[] = TeamMemberFunctionPeer::IS_NEWLY_UPDATED;
        }
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TeamMemberFunctionQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // denyable behavior
            if(!(TeamMemberFunctionPeer::isIgnoringRights() || $this->mayOperate("delete"))) {
                throw new PropelException(new NotPermittedException("delete.by_role", array("role_key" => "team_member_functions")));
            }
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // denyable behavior
                if(!(TeamMemberFunctionPeer::isIgnoringRights() || $this->mayOperate("insert"))) {
                    throw new PropelException(new NotPermittedException("insert.by_role", array("role_key" => "team_member_functions")));
                }
                ...
                // denyable behavior
                if(!(TeamMemberFunctionPeer::isIgnoringRights() || $this->mayOperate("update"))) {
                    throw new PropelException(new NotPermittedException("update.by_role", array("role_key" => "team_member_functions")));
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TeamMemberFunctionPeer::TEAM_MEMBER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`team_member_id`';
        }
        if ($this->isColumnModified(TeamMemberFunctionPeer::SCHOOL_FUNCTION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`school_function_id`';
        }
        if ($this->isColumnModified(TeamMemberFunctionPeer::IS_MAIN_FUNCTION)) {
            $modifiedColumns[':p' . $index++]  = '`is_main_function`';
        }
        if ($this->isColumnModified(TeamMemberFunctionPeer::IS_NEWLY_UPDATED)) {
        ...
        $sql = sprintf(
            'INSERT INTO `team_member_functions` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`team_member_id`':
                        ...
                        break;
                    case '`school_function_id`':
                        $stmt->bindValue($identifier, $this->school_function_id, PDO::PARAM_INT);
                        break;
                    case '`is_main_function`':
                        $stmt->bindValue($identifier, (int) $this->is_main_function, PDO::PARAM_INT);
                        break;
    ...
    {
        if (isset($alreadyDumpedObjects['TeamMemberFunction'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TeamMemberFunction'][serialize($this->getPrimaryKey())] = true;
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aSchoolFunction) {
                $result['SchoolFunction'] = $this->aSchoolFunction->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TeamMemberFunctionPeer::IS_NEWLY_UPDATED)) $criteria->add(TeamMemberFunctionPeer::IS_NEWLY_UPDATED, $this->is_newly_updated);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setSchoolFunctionId($this->getSchoolFunctionId());
        $copyObj->setIsMainFunction($this->getIsMainFunction());
     ...
     * @throws PropelException
     */
    public function getSchoolFunction(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSchoolFunction === null && ($this->school_function_id !== null) && $doQuery) {
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aSchoolFunction instanceof Persistent) {
              $this->aSchoolFunction->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(TeamMemberFunctionPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && TeamMemberFunctionPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(TeamMemberFunctionPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleTeamMemberFunctionOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }

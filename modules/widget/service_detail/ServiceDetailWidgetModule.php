...
class ServiceDetailWidgetModule extends PersistentWidgetModule {
    ...
    // config section 'school_settings' :'externally_managed_categories'
		...
		$this->setSetting('service_file_category_id', SchoolPeer::getCategoryConfig('service_files'));
	}
	...
	public function saveData($aServiceData) {
		...
		$oService->setBody(RichtextUtil::parseInputFromMceForStorage($aServiceData['body_text']));
		if(!$oService->isNew()) {
